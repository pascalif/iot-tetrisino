...
Toute chaine de caractère hardcodée consomme dans le décompte des "Global variables".
...
==> DESACTIVER LES LOGS avant toute chose ! Malgré les pourcentages ci-dessus, il peut y avoir des débordements très vite.
...
Alors vérifier les résistances des cables VCC et GND avant/apres le master switch
  ...
  Si pas de solution, le bypasser temporairement sur le mini breadboard rouge intégré dans le chassis.
